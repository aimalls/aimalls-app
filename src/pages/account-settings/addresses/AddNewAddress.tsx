            ...
            <IonContent>
                <IonList lines="full">
                    ...
                    <IonItem>
                        ...
                        >
                            { cityOptions.map((city: iProvince) => (
                ...
                <IonList lines="full">
                    ...
                    <IonItem>
                        ...
                        <IonButton onClick={() => handleAddressLabelChange("Home")} color={settings.label === "Home" ? "primary" : "light"}>Home</IonButton>
                        <IonButton onClick={() => handleAddressLabelChange("Work")} color={settings.label === "Work" ? "primary" : "light"}>Work</IonButton>
                    </IonItem>
                    <IonItem>
