...
export const BuyNow: React.FC<BuyNowProp> = ({ product }) => {
    ...
    const buyNowDialog = useRef<HTMLIonModalElement>(null)
    ...
    return (
        <>
            <IonButton fill="solid" id="buy-now-dialog-trigger" onClick={() => buyNowDialog.current?.present()}>Buy Now</IonButton>

            <IonModal 
                ref={buyNowDialog} 
                trigger="buy-now-dialog-trigger"
                    ...
                    <IonGrid style={{ marginTop: "10px" }}>
                        <IonRow>
                            <IonCol size="12" class="ion-sales-info-details">
                                <IonButton fill="clear" className="close-button" onClick={() => buyNowDialog.current?.dismiss()}>
                        ...
                        <IonRow>
                            <IonCol size="12">
                                <IonButton disabled={!isCartable} expand="block" onClick={() => handleBuyNow()}>Buy Now</IonButton>
                            </IonCol>
                        </IonRow>
